        ...
        {
            {
                ...
                string current_path = emp.img_name.Replace(removepath, "https://raw.githubusercontent.com/Ishita25-sys/OneMoreShot/master/1/");
                    ...
                    if (date1 == emp.EmpBDate)
                    {
                        ...
                        .birthday-post {{position: relative;
                        ...
                        .employee-photo-container {{position: absolute;
                        ...
                        .employee-photo {{width: 100%;
                            height: 100%;
                            object-fit: cover;
                        }}

                        .employee-info {{position: absolute;
...
//< link rel = 'stylesheet' href = 'https://raw.githubusercontent.com/Ishita25-sys/birthday-mail/master/style1.css' >
